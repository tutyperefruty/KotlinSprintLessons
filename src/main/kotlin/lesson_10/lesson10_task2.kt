...
fun main() {
    ...
    val newPass = readln()
    if ((validateLoginAndPasswordLength(vhodnieDannie1 = newLogin, vhodnieDannie2 = newPass)) == true) {
...
fun validateLoginAndPasswordLength(vhodnieDannie1: String, vhodnieDannie2: String): Boolean =
    ((vhodnieDannie1.length >= MIN_LENGTH) and (vhodnieDannie2.length >= MIN_LENGTH))